...
'laravelmysql' => [
    ...
    'uidfield' => 'email', //field to query username against 
],
    ...
    */
    ...
    'example-ldap' => [
        ...
        'hostname' => 'phidc01.packeth.local',
        ...
        'search.base' => 'dc=packeth,dc=local',
        ...
        'search.username' => 'lloyd@packeth.local',
        'search.password' => 'lthdbu01%',
